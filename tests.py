import unittest
from source.parking_lot_components import create_parking_lot, park_car, parking_lot_is_full, car_departure, \
...
class TestParkingLotFunctions(unittest.TestCase):
    ...
    def test_park_car_lot_not_defined(self):
        testString = park_car(None, 'KA-01-HH-1234', 'White')
        self.assertEqual('Parking lot is not defined', testString)

    def test_park_car_lot_allocated(self):
        testParkingLot = create_parking_lot(str(6))
        testString = park_car(testParkingLot, 'KA-01-HH-9999', 'White')
    ...
    def test_park_car_lot_full(self):
        ...
        testParkString = park_car(testParkingLot, 'KA-01-HH-9999', 'White')
    ...
    def test_car_departure_free(self):
        testParkingLot = create_parking_lot(str(6))
        testParkString = park_car(testParkingLot, 'KA-01-BB-0001', 'White')
        testString = car_departure(testParkingLot, '1')
